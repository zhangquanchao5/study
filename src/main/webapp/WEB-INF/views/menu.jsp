...
<div class="h_t_searchCont">
    <ul>
        ...
        <li class="hotIcon"><a href="${pageContext.request.contextPath}/user/register">机构入驻<img src="${pageContext.request.contextPath}/resources/images/newIcon.png" class="hotIconImg"/></a></li>
